...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_LGUI,     KC_Z,     KC_X,     KC_C,     KC_V,       KC_B,                                     KC_N,       KC_M,       KC_COMM,   KC_DOT,    KC_SLSH,  KC_ENT, \
                                             KC_LCTRL,   MO(_LOWER), KC_SPC,             KC_RSFT,  MO(_RAISE), KC_LALT \
  ),
  ...
  _______, _______, _______, _______,  _______, _______,                                   KC_RBRC,      KC_1,      KC_2,   KC_3,    KC_EQL,  _______, \
  ...
  _______,   XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,   XXXXXXX,                                    KC_MPLY, KC_END,  KC_PGDN, KC_VOLD, KC_MNXT, KC_MUTE, \
